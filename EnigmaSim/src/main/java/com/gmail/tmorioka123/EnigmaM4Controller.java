...
@Controller
public class EnigmaM4Controller {
	...
	private final int rrTypeSetID=3;
	private final int enigmaTypeID=2;
	private final int refOffset=3;

	@Autowired
	public EnigmaM4Controller(PbSettingRepository pRepository,
	...
	public RRTypeSetting setRRTSet () {
	...
	@RequestMapping(value = "/enigma_M4/", method = RequestMethod.GET)
	public ModelAndView start(@ModelAttribute("pbSet") PbSetting pbSet,@ModelAttribute("rrTSet")RRTypeSetting rrTSet,
		...
		mav.setViewName("/enigma_M4/index");
		return mav;
	}
	@RequestMapping(value = "/enigma_M4/index", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/enigma_M4/rrSetting",method = RequestMethod.GET)
	public ModelAndView showRotorRefSetting(@ModelAttribute("pbSet") PbSetting pbSet,@ModelAttribute("rrTSet")RRTypeSetting rrTSet,
			@ModelAttribute("rrSet")RRSetting rrSet,@ModelAttribute("dSet")UKWDSetting dSet,
			@ModelAttribute("iom")InputOutputManager iom,@ModelAttribute("edm")EnigmaDataManager edm,ModelAndView mav){
		mav=regetSetting(pbSet,rrTSet,rrSet, dSet, mav);
		mav.addObject("edm", this.edm);
		mav.setViewName("/enigma_M4/rrSetting");
		return mav;
	}
	@RequestMapping(value = "/enigma_M4/rrSetting",method = RequestMethod.POST)
	public ModelAndView setRotorRefSetting(@ModelAttribute("pbSet") PbSetting pbSet,@ModelAttribute("rrTSet")RRTypeSetting rrTSet,
		...
		return new ModelAndView("redirect:/enigma_M4/index");
	}
	@RequestMapping(value = "/enigma_M4/pbSetting",method = RequestMethod.GET)
	public ModelAndView showPlugboardSetting(@ModelAttribute("pbSet") PbSetting pbSet,@ModelAttribute("rrTSet")RRTypeSetting rrTSet,
			@ModelAttribute("rrSet")RRSetting rrSet,@ModelAttribute("dSet")UKWDSetting dSet,
			@ModelAttribute("iom")InputOutputManager iom,ModelAndView mav){
		mav=regetSetting(pbSet,rrTSet,rrSet, dSet, mav);
		mav.addObject("edm", this.edm);
		mav.setViewName("/enigma_M4/pbSetting");
		return mav;
	}
	@RequestMapping(value = "/enigma_M4/pbSetting",method = RequestMethod.POST)
	public ModelAndView setPlugboardSetting(@ModelAttribute("pbSet") PbSetting pbSet,@ModelAttribute("rrTSet")RRTypeSetting rrTSet,
		...
		edm.setPbValid(false);
		mav.addObject("edm",this.edm);
		return mav;
	}
	@RequestMapping(value = "/enigma_M4/pbSetting/random",method = RequestMethod.GET)
	...
	@RequestMapping(value = "/enigma_M4/ukwDSetting",method = RequestMethod.GET)
	public ModelAndView showUKWDSetting(@ModelAttribute("pbSet") PbSetting pbSet,@ModelAttribute("rrTSet")RRTypeSetting rrTSet,
		...
		mav.addObject("edm", this.edm);
		mav.addObject("Msg", "");
		mav.setViewName("/enigma_M4/ukwDSetting");
		return mav;
	}
	@RequestMapping(value = "/enigma_M4/ukwDSetting",method = RequestMethod.POST)
	public ModelAndView setUKWDSetting(@ModelAttribute("pbSet") PbSetting pbSet,@ModelAttribute("rrTSet")RRTypeSetting rrTSet,
		...
		if(edm.checkIsUKWDSetValid(dSet.getUkwDSet0(),dSet.getUkwDSet1(),dSet.getUkwDSet2(),dSet.getUkwDSet3(),
			...
			edm.setUKWDValid(true);
			return new ModelAndView("redirect:/enigma_M4/index");
		}else{
			dRepository.saveAndFlush(dSet);
			mav=regetSetting(pbSet,rrTSet,rrSet, dSet, mav);
			mav.addObject("Msg", "値が不正です。確認し入力しなおしてください。");
			edm.setUKWDValid(false);
			mav.addObject("edm",this.edm);
			return mav;
		}
	}
	@RequestMapping(value = "/enigma_M4/ukwDSetting/random",method = RequestMethod.GET)
	...
	@RequestMapping(value = "/enigma_M4/modelChange", method = RequestMethod.GET)
	public ModelAndView showModelChange(@ModelAttribute("pbSet") PbSetting pbSet,@ModelAttribute("rrTSet")RRTypeSetting rrTSet,
			@ModelAttribute("rrSet")RRSetting rrSet,@ModelAttribute("dSet")UKWDSetting dSet,
			@ModelAttribute("iom")InputOutputManager iom,ModelAndView mav){
		mav=regetSetting(pbSet,rrTSet,rrSet, dSet, mav);
		mav.addObject("edm", this.edm);
		mav.setViewName("/enigma_M4/modelChange");
		return mav;
	}
	@RequestMapping(value = "/enigma_M4/modelChange", method = RequestMethod.POST)
	@Transactional(readOnly=false)
	public ModelAndView setModelChange(@RequestParam int enigmaType,@ModelAttribute("eTSet") ETypeSetting eTSet,
			@ModelAttribute("pbSet") PbSetting pbSet,@ModelAttribute("rrSet")RRSetting rrSet,@ModelAttribute("dSet")UKWDSetting dSet,
			@ModelAttribute("iom")InputOutputManager iom,ModelAndView mav){
	...
	@RequestMapping(value = "/enigma_M4/instruction", method = RequestMethod.GET)
	public ModelAndView showInstruction(@ModelAttribute("pbSet") PbSetting pbSet,@ModelAttribute("rrTSet")RRTypeSetting rrTSet,
			@ModelAttribute("rrSet")RRSetting rrSet,@ModelAttribute("dSet")UKWDSetting dSet,
			@ModelAttribute("iom")InputOutputManager iom,ModelAndView mav){
		mav=regetSetting(pbSet, rrTSet, rrSet, dSet, mav);
		mav.addObject("edm", this.edm);
		mav.setViewName("/enigma_M4/instruction");
		return mav;
	}
	@RequestMapping(value = "/enigma_M4/doEnigma", method = RequestMethod.POST)
	@Transactional(readOnly=false)
	...
	public ModelAndView regetSetting(PbSetting pbSet,RRTypeSetting rrTSet,
		...
		mav.addObject("refTypeByName2",edm.getRefsetByName2());
